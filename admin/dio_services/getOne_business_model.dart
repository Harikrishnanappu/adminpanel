...
//
//     final getOneBusiness = getOneBusinessFromJson(jsonString);

import 'dart:convert';

GetOneBusiness getOneBusinessFromJson(String str) =>
    GetOneBusiness.fromJson(json.decode(str));

String getOneBusinessToJson(GetOneBusiness data) => json.encode(data.toJson());

class GetOneBusiness {
  Business business;
  String message;
  ...
  factory GetOneBusiness.fromJson(Map<String, dynamic> json) => GetOneBusiness(
